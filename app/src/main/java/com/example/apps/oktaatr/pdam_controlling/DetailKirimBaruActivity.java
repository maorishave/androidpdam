...
public class DetailKirimBaruActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_kirim_baru);
        id = bundle.getString("id");
        nobonc = bundle.getString("nobonc");
        pemakaianairList = new ArrayList<>();
        no_bonc = (TextView) findViewById(R.id.dkb_nobonc);
        tgl_bonc = (TextView) findViewById(R.id.dkb_tgl_boc);
        no_pel = (TextView) findViewById(R.id.dkb_nopel);
        nama_pel = (TextView) findViewById(R.id.dkb_namapel);
        alm_pel = (TextView) findViewById(R.id.dkb_almpel);
        sumb_data = (TextView) findViewById(R.id.dkb_sumbdata);
        asal_peng = (TextView) findViewById(R.id.dkb_asal_adu);
        retribusi = (TextView) findViewById(R.id.dkb_retribusi);
        kode_tarif = (TextView) findViewById(R.id.dkb_kode_tarif);
        no_PA = (TextView) findViewById(R.id.dkb_noPA);
        data_meter = (TextView) findViewById(R.id.dkb_data_meter);
        permasalahan = (TextView) findViewById(R.id.dkb_permasalahan);
...
//                Intent intent = new Intent(DetailKirimBaruActivity.this, KirimBaruActivity.class);
//
//                startActivity(intent);
        ...
        btnlihatform.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DetailKirimBaruActivity.this, FormHasilKontrolActivity.class);
