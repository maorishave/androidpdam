...
public class FormProsesRevActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_prosesrev);
        Bundle bundle = getIntent().getExtras();
        id = bundle.getString("id");
        no_bon = (TextView) findViewById(R.id.no_bon_pr);
        stand_meter = (TextInputEditText) findViewById(R.id.stand_meter_pr);
        tgl_stand_meter = (TextInputEditText) findViewById(R.id.tgl_stand_meter_pr);
        nomor_meter = (TextInputEditText) findViewById(R.id.nomor_meter_pr);
        ukuran = (TextInputEditText) findViewById(R.id.ukuran_pr);
        merk_meter = (TextInputEditText) findViewById(R.id.merk_meter_pr);
        mulai_aliran_air = (TextInputEditText) findViewById(R.id.mulai_aliran_air_pr);
        akhir_aliran_air = (TextInputEditText) findViewById(R.id.akhir_aliran_air_pr);
        guna_persil = (TextInputEditText) findViewById(R.id.guna_persil_pr);
        jml_jiwa = (TextInputEditText) findViewById(R.id.jml_jiwa_pr);
        tlp_plg = (TextInputEditText) findViewById(R.id.tlp_plg_pr);
        keterangan = (TextInputEditText) findViewById(R.id.keterangan_pr);
        kesimpulan = (TextInputEditText) findViewById(R.id.kesimpulantl_pr);

        Spkds_meter = (Spinner) findViewById(R.id.kds_meter_pr);
        Spkds_air = (Spinner) findViewById(R.id.kds_air_pr);
        Spsegel_meter = (Spinner) findViewById(R.id.segel_meter_pr);
        Spsegel_kopling = (Spinner) findViewById(R.id.segel_kopling_pr);
        Sppipa_phb = (Spinner) findViewById(R.id.pipa_phb_pr);
        Spletak_meter = (Spinner) findViewById(R.id.letak_meter_pr);
        Spmin_charge = (Spinner) findViewById(R.id.min_charge_pr);
        Spplg_pangil = (Spinner) findViewById(R.id.plg_panggil_pr);
        Spsumur = (Spinner) findViewById(R.id.sumur_pr);
        Spsituasi_persil = (Spinner) findViewById(R.id.situasi_persil_pr);
        gambar1 = (ImageView) findViewById(R.id.gambar1_pr);
        gambar2 = (ImageView) findViewById(R.id.gambar2_pr);
        gambar3 = (ImageView) findViewById(R.id.gambar3_pr);
        fotottd = (ImageView) findViewById(R.id.qrttd_pr);
        ...
        fotottd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(FormProsesRevActivity.this, TandaTanganActivity.class);
...
//                startActivity(iAdd);
        ...
        btnKirim = (Button) findViewById(R.id.btnKirimForm_pr);
...
//                            st_Spplg_pangil, st_guna_persil, st_jml_jiwa, st_Spsumur, st_tlp_plg, st_Spsituasi_persil);
                    pDialog = new ProgressDialog(FormProsesRevActivity.this, R.style.Theme_AppCompat_DayNight_Dialog);
                    ...
                    call.enqueue(new Callback<Datainput>() {
                        ...
                        public void onResponse(Call<Datainput> call, retrofit2.Response<Datainput> response) {
                            if (response.body().getCode() == 302) {
                                ...
                                Toast.makeText(FormProsesRevActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
                                //sessionManager.CreateLoginSession(data.getId(),response.body().getCode());
                                Intent dashboard = new Intent(FormProsesRevActivity.this, MainActivity.class);
                        ...
                        public void onFailure(Call<Datainput> call, Throwable t) {
                            Toast.makeText(FormProsesRevActivity.this, "Error Bro", Toast.LENGTH_SHORT).show();

                        }
                    });
                }else {
                    Toast.makeText(FormProsesRevActivity.this, "data kosong", Toast.LENGTH_SHORT).show();
                }
            }
        });
...
//                            st_Spplg_pangil, st_guna_persil, st_jml_jiwa, st_Spsumur, st_tlp_plg, st_Spsituasi_persil);
                    ...
                    Toast.makeText(FormProsesRevActivity.this, "Masukkan tanggal", Toast.LENGTH_SHORT).show();
                }
            }
        });
        getProsesSimpan();
        ...
        call.enqueue(new Callback<DataHasilModel>() {
            ...
            public void onResponse(Call<DataHasilModel> call, Response<DataHasilModel> response) {
                if (response.body().getCode() == 302){
                    ...
                    Glide.with(FormProsesRevActivity.this).load(Api.BASE_URL + "/laravelku/public/uploads/foto-realisasi/" + realisasi.getFotometer()).into(gambar1);
                    Glide.with(FormProsesRevActivity.this).load(Api.BASE_URL + "/laravelku/public/uploads/foto-realisasi/" + realisasi.getFotopersil()).into(gambar2);
                    Glide.with(FormProsesRevActivity.this).load(Api.BASE_URL + "/laravelku/public/uploads/foto-realisasi/" + realisasi.getFotopelanggan()).into(gambar3);
                    Glide.with(FormProsesRevActivity.this).load(Api.BASE_URL + "/laravelku/public/uploads/foto-realisasi/" + realisasi.getFotottd()).into(fotottd);
                    Toast.makeText(FormProsesRevActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
...
//            Log.v(TAG,"Permission is granted2");
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if(ActivityCompat.checkSelfPermission(this, permissions[0]) == PackageManager.PERMISSION_GRANTED){
            ...
            if (!folder.exists()) {
                Toast.makeText(FormProsesRevActivity.this, "Directory Does Not Exist, Create It", Toast.LENGTH_SHORT).show();
                success = folder.mkdir();
            }
            if (success) {
                Toast.makeText(FormProsesRevActivity.this, "Directory Created", Toast.LENGTH_SHORT).show();
            } else {
