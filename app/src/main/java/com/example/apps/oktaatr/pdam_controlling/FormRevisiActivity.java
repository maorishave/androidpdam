...
public class FormRevisiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_revisi);
        Bundle bundle=getIntent().getExtras();
        no_bon = (TextView) findViewById(R.id.no_bon_rev);
        stand_meter = (TextInputEditText) findViewById(R.id.stand_meter_rev);
        tgl_stand_meter = (TextInputEditText) findViewById(R.id.tgl_stand_meter_rev);
        nomor_meter = (TextInputEditText) findViewById(R.id.nomor_meter_rev);
        ukuran = (TextInputEditText) findViewById(R.id.ukuran_rev);
        merk_meter = (TextInputEditText) findViewById(R.id.merk_meter_rev);
        mulai_aliran_air = (TextInputEditText) findViewById(R.id.mulai_aliran_air_rev);
        akhir_aliran_air = (TextInputEditText) findViewById(R.id.akhir_aliran_air_rev);
        guna_persil = (TextInputEditText) findViewById(R.id.guna_persil_rev);
        jml_jiwa = (TextInputEditText) findViewById(R.id.jml_jiwa_rev);
        tlp_plg = (TextInputEditText) findViewById(R.id.tlp_plg_rev);
        keterangan = (TextInputEditText) findViewById(R.id.keterangan_rev);
        kesimpulan = (TextInputEditText) findViewById(R.id.kesimpulantl_rev);

        Spkds_meter = (Spinner) findViewById(R.id.kds_meter_rev);
        Spkds_air = (Spinner) findViewById(R.id.kds_air_rev);
        Spsegel_meter = (Spinner) findViewById(R.id.segel_meter_rev);
        Spsegel_kopling = (Spinner) findViewById(R.id.segel_kopling_rev);
        Sppipa_phb = (Spinner) findViewById(R.id.pipa_phb_rev);
        Spletak_meter = (Spinner) findViewById(R.id.letak_meter_rev);
        Spmin_charge = (Spinner) findViewById(R.id.min_charge_rev);
        Spplg_pangil = (Spinner) findViewById(R.id.plg_panggil_rev);
        Spsumur = (Spinner) findViewById(R.id.sumur_rev);
        Spsituasi_persil = (Spinner) findViewById(R.id.situasi_persil_rev);
        gambar1 = (ImageView) findViewById(R.id.gambar1_rev);
        gambar2 = (ImageView) findViewById(R.id.gambar2_rev);
        gambar3 = (ImageView) findViewById(R.id.gambar3_rev);
        fotottd = (ImageView) findViewById(R.id.qrttd_rev);
        ...
        fotottd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(FormRevisiActivity.this, TandaTanganActivity.class);
        ...
        btnback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
//                Intent iAdd = new Intent(FormRevisiActivity.this, RevisiBaruActivity.class);
//                startActivity(iAdd);
                onBackPressed();
            }
        });
        ...
        btnSimpan = (Button) findViewById(R.id.btnSimpanForm_rev);
...
//                            st_Spplg_pangil, st_guna_persil, st_jml_jiwa, st_Spsumur, st_tlp_plg, st_Spsituasi_persil);
                    pDialog = new ProgressDialog(FormRevisiActivity.this, R.style.Theme_AppCompat_DayNight_Dialog);
                    ...
                    call.enqueue(new Callback<Datainput>() {
                        ...
                        public void onResponse(Call<Datainput> call, retrofit2.Response<Datainput> response) {
                            if (response.body().getCode() == 302) {
                                ...
                                Toast.makeText(FormRevisiActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
                                //sessionManager.CreateLoginSession(data.getId(),response.body().getCode());
                                Intent dashboard = new Intent(FormRevisiActivity.this, MainActivity.class);
                        ...
                        public void onFailure(Call<Datainput> call, Throwable t) {
                            Toast.makeText(FormRevisiActivity.this, "Error Bro", Toast.LENGTH_SHORT).show();

                        }
                    });
                }else {
                    Toast.makeText(FormRevisiActivity.this, "Masukkan tanggal", Toast.LENGTH_SHORT).show();
                }
            }
        });
        btnKirim = (Button) findViewById(R.id.btnKirimForm_rev);
        btnKirim.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (!st_stand_meter.isEmpty() && !st_tgl_stand_meter.isEmpty()
                    ...
                    rb_kesimpulan = RequestBody.create(okhttp3.MultipartBody.FORM, st_kesimpulan);
                    rb_Spsituasi_persil = RequestBody.create(okhttp3.MultipartBody.FORM, st_Spsituasi_persil);
//                    doInputFormBaru (st_stand_meter, st_tgl_stand_meter, st_nomor_meter, st_ukuran, st_merk_meter,
//                            st_Spkds_meter, st_Spkds_air, st_mulai_aliran_air, st_akhir_aliran_air, st_Spsegel_meter,
//                            st_Spsegel_kopling, st_Sppipa_phb, st_Spletak_meter, st_Spmin_charge,
//                            st_Spplg_pangil, st_guna_persil, st_jml_jiwa, st_Spsumur, st_tlp_plg, st_Spsituasi_persil);
                    pDialog = new ProgressDialog(FormRevisiActivity.this, R.style.Theme_AppCompat_DayNight_Dialog);
                    ...
                    PostService service = Api.getClient().create(PostService.class);
                    Call<Datainput> call = service.postFormInput(st_bonc_id,rb_stand_meter, rb_tgl_stand_meter, rb_nomor_meter,
                            rb_ukuran, rb_merk_meter, rb_Spkds_meter, rb_Spkds_air, rb_mulai_aliran_air, rb_akhir_aliran_air,
                            rb_Spsegel_meter, rb_Spsegel_kopling, rb_Sppipa_phb, rb_Spletak_meter, rb_Spmin_charge,
                            rb_Spplg_pangil, rb_guna_persil, rb_jml_jiwa, rb_Spsumur, rb_tlp_plg, rb_Spsituasi_persil,
                            rb_keterangan, rb_kesimpulan, rb_bonc_id, gambarmeter, gambarpersil, gambarpelanggan, gambarttd);
                    call.enqueue(new Callback<Datainput>() {
                        @Override
                        public void onResponse(Call<Datainput> call, retrofit2.Response<Datainput> response) {
                            if (response.body().getCode() == 302) {
                    ...
                    Toast.makeText(FormRevisiActivity.this, "data kosong", Toast.LENGTH_SHORT).show();
                }
            }
        });
...
//            Log.v(TAG,"Permission is granted2");
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if(ActivityCompat.checkSelfPermission(this, permissions[0]) == PackageManager.PERMISSION_GRANTED){
            ...
            if (!folder.exists()) {
                Toast.makeText(FormRevisiActivity.this, "Directory Does Not Exist, Create It", Toast.LENGTH_SHORT).show();
                success = folder.mkdir();
            }
            if (success) {
                Toast.makeText(FormRevisiActivity.this, "Directory Created", Toast.LENGTH_SHORT).show();
            } else {
...
//                Toast.makeText(FormRevisiActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
//                //sessionManager.CreateLoginSession(data.getId(),response.body().getCode());
//                Intent dashboard = new Intent(FormRevisiActivity.this, RevisiFragment.class);
//                startActivity(dashboard);
//                finish();
//                } else {
//                    Toast.makeText(FormRevisiActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
...
//                Fragment fragment = new RevisiFragment ();
...
//            @Override
//            public void onFailure(Call<Datainput> call, Throwable t) {
//                Toast.makeText(FormRevisiActivity.this, "Ada kesalahan", Toast.LENGTH_SHORT).show();
//            }
//
//
//        });
